...
- [`sdk/go/`](sdk/go/) — Go bindings, module `github.com/ubiquex/ubx-sdk-datadog/sdk/go/v2`
  (a subdirectory Go module, tagged `sdk/go/vX.Y.Z`)
- [`sdk/typescript/`](sdk/typescript/) — TypeScript bindings, published to npm as
  [`@ubx/sdk-datadog`](https://www.npmjs.com/package/@ubx/sdk-datadog)
...
```
go get github.com/ubiquex/ubx-sdk-datadog/sdk/go/v2
...
<!-- README-GEN:BEGIN -->
**Real, current counts** (`ubx sdk gen --dump-ir`): 178 resource types, 452 data source types.

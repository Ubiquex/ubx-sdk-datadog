...
export interface ListItem_Dashboards_Author {
  email?: string | Computed<string>;
  handle?: string | Computed<string>;
  name?: string | Computed<string>;
}

export interface ListItem_Dashboards {
  author?: ListItem_Dashboards_Author | Computed<ListItem_Dashboards_Author>;
...
export interface ListItemAttrs {
  ...
  dashboards: ListItem_Dashboards[];

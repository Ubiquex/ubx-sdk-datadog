// Code generated by `ubx sdk gen` from datadog_slohistory_response_error_list. DO NOT EDIT.
import type { Computed, FieldMap, DataSourceBinding } from "@ubx/sdk";

export interface ResponseErrorList_Data_Groups_Errors {
  errorMessage?: string | Computed<string>;
  errorType?: string | Computed<string>;
}

export interface ResponseErrorList_Data_Groups {
  errorBudgetRemaining?: Record<string, number> | Computed<Record<string, number>>;
  errors?: ResponseErrorList_Data_Groups_Errors[] | Computed<ResponseErrorList_Data_Groups_Errors[]>;
...
export interface ResponseErrorList_Data_Overall {
...
export interface ResponseErrorList_Data_Series_Denominator_Metadata_Unit {
...
export interface ResponseErrorList_Data_Series_Denominator_Metadata {
  ...
  unit?: ResponseErrorList_Data_Series_Denominator_Metadata_Unit[] | Computed<ResponseErrorList_Data_Series_Denominator_Metadata_Unit[]>;
}

export interface ResponseErrorList_Data_Series_Denominator {
  /** Count of submitted metrics. */
  count: number | Computed<number>;
  /** Query metadata. */
  metadata?: ResponseErrorList_Data_Series_Denominator_Metadata | Computed<ResponseErrorList_Data_Series_Denominator_Metadata>;
...
export interface ResponseErrorList_Data_Series {
  ...
  denominator: ResponseErrorList_Data_Series_Denominator | Computed<ResponseErrorList_Data_Series_Denominator>;
  ...
  /** A representation of `metric` based SLO timeseries for the provided queries. This is the same response type from `batch_query` endpoint. */
  numerator: ResponseErrorList_Data_Series_Denominator | Computed<ResponseErrorList_Data_Series_Denominator>;
...
export interface ResponseErrorList_Data_Thresholds {
...
export interface ResponseErrorList_Data {
  ...
  groups?: ResponseErrorList_Data_Groups[] | Computed<ResponseErrorList_Data_Groups[]>;
  ...
  monitors?: ResponseErrorList_Data_Groups[] | Computed<ResponseErrorList_Data_Groups[]>;
  ...
  overall?: ResponseErrorList_Data_Overall | Computed<ResponseErrorList_Data_Overall>;
  /** A `metric` based SLO history response. This is not included in responses for `monitor` based SLOs. */
  series?: ResponseErrorList_Data_Series | Computed<ResponseErrorList_Data_Series>;
  /** mapping of string timeframe to the SLO threshold. */
  thresholds?: Record<string, ResponseErrorList_Data_Thresholds> | Computed<Record<string, ResponseErrorList_Data_Thresholds>>;
...
export interface ResponseErrorList_Errors {
  error?: string | Computed<string>;
}

export interface ResponseErrorListConfig {
...
export interface ResponseErrorListAttrs {
  applyCorrection: boolean;
  /** An array of service level objective objects. */
  data: ResponseErrorList_Data;
  /** A list of errors while querying the history data for the service level objective. */
  errors: ResponseErrorList_Errors[];
  fromTs: number;
  sloId: string;
  target: number;
  toTs: number;
...
export const ResponseErrorList: DataSourceBinding<ResponseErrorListConfig, ResponseErrorListAttrs> = {
  wireType: "datadog_slohistory_response_error_list",
  fields: {

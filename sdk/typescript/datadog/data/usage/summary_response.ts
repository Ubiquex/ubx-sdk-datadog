...
export interface SummaryResponse_LogsByRetention_Orgs_Usage_Usage {
  logsIndexedLogsUsageSum?: number | Computed<number>;
  logsLiveIndexedLogsUsageSum?: number | Computed<number>;
  logsRehydratedIndexedLogsUsageSum?: number | Computed<number>;
  retention?: string | Computed<string>;
}

export interface SummaryResponse_LogsByRetention_Orgs_Usage {
  usage?: SummaryResponse_LogsByRetention_Orgs_Usage_Usage[] | Computed<SummaryResponse_LogsByRetention_Orgs_Usage_Usage[]>;
}

export interface SummaryResponse_LogsByRetention_Orgs {
  /** Indexed logs usage summary for each organization. */
  usage?: SummaryResponse_LogsByRetention_Orgs_Usage[] | Computed<SummaryResponse_LogsByRetention_Orgs_Usage[]>;
}

export interface SummaryResponse_LogsByRetention_Usage {
  logsIndexedLogsUsageAggSum?: number | Computed<number>;
  logsLiveIndexedLogsUsageAggSum?: number | Computed<number>;
  logsRehydratedIndexedLogsUsageAggSum?: number | Computed<number>;
  retention?: string | Computed<string>;
}

export interface SummaryResponse_LogsByRetention_UsageByMonth {
...
export interface SummaryResponse_LogsByRetention {
  /** Indexed logs usage summary for each organization for each retention period with usage. */
  orgs?: SummaryResponse_LogsByRetention_Orgs | Computed<SummaryResponse_LogsByRetention_Orgs>;
  /** Aggregated index logs usage for each retention period with usage. */
  usage?: SummaryResponse_LogsByRetention_Usage[] | Computed<SummaryResponse_LogsByRetention_Usage[]>;
  /** Object containing a summary of indexed logs usage by retention period for a single month. */
  usageByMonth?: SummaryResponse_LogsByRetention_UsageByMonth | Computed<SummaryResponse_LogsByRetention_UsageByMonth>;
}

export interface SummaryResponse_Usage_Orgs {
  accountName?: string | Computed<string>;
  accountPublicId?: string | Computed<string>;
  agentHostTop99p?: number | Computed<number>;
  aiCreditsAgentBuilderAiCreditsSum?: number | Computed<number>;
  aiCreditsBitsAssistantAiCreditsSum?: number | Computed<number>;
  aiCreditsBitsDevAiCreditsSum?: number | Computed<number>;
  aiCreditsBitsSreAiCreditsSum?: number | Computed<number>;
  aiCreditsSum?: number | Computed<number>;
  apmAzureAppServiceHostTop99p?: number | Computed<number>;
  apmDevsecopsHostTop99p?: number | Computed<number>;
  apmEnterpriseStandaloneHostsTop99p?: number | Computed<number>;
  apmFargateCountAvg?: number | Computed<number>;
  apmHostTop99p?: number | Computed<number>;
  apmProStandaloneHostsTop99p?: number | Computed<number>;
  appsecFargateCountAvg?: number | Computed<number>;
  asmServerlessSum?: number | Computed<number>;
  auditLogsLinesIndexedSum?: number | Computed<number>;
  auditTrailEnabledHwm?: number | Computed<number>;
  auditTrailEventForwardingEventsSum?: number | Computed<number>;
  avgProfiledFargateTasks?: number | Computed<number>;
  awsHostTop99p?: number | Computed<number>;
  awsLambdaFuncCount?: number | Computed<number>;
  awsLambdaInvocationsSum?: number | Computed<number>;
  azureAppServiceTop99p?: number | Computed<number>;
  billableIngestedBytesSum?: number | Computed<number>;
  bitsAiInvestigationsSum?: number | Computed<number>;
  browserRumLiteSessionCountSum?: number | Computed<number>;
  browserRumReplaySessionCountSum?: number | Computed<number>;
  browserRumUnitsSum?: number | Computed<number>;
  ccmAnthropicSpendLast?: number | Computed<number>;
  ccmAwsSpendLast?: number | Computed<number>;
  ccmAzureSpendLast?: number | Computed<number>;
  ccmConfluentSpendLast?: number | Computed<number>;
  ccmDatabricksSpendLast?: number | Computed<number>;
  ccmElasticSpendLast?: number | Computed<number>;
  ccmFastlySpendLast?: number | Computed<number>;
  ccmGcpSpendLast?: number | Computed<number>;
  ccmGithubSpendLast?: number | Computed<number>;
  ccmMongodbSpendLast?: number | Computed<number>;
  ccmOciSpendLast?: number | Computed<number>;
  ccmOpenaiSpendLast?: number | Computed<number>;
  ccmSnowflakeSpendLast?: number | Computed<number>;
  ccmSpendMonitoredEntLast?: number | Computed<number>;
  ccmSpendMonitoredProLast?: number | Computed<number>;
  ccmTwilioSpendLast?: number | Computed<number>;
  ciPipelineIndexedSpansSum?: number | Computed<number>;
  ciTestIndexedSpansSum?: number | Computed<number>;
  ciVisibilityItrCommittersHwm?: number | Computed<number>;
  ciVisibilityPipelineCommittersHwm?: number | Computed<number>;
  ciVisibilityTestCommittersHwm?: number | Computed<number>;
  cloudCostManagementAwsHostCountAvg?: number | Computed<number>;
  cloudCostManagementAzureHostCountAvg?: number | Computed<number>;
  cloudCostManagementGcpHostCountAvg?: number | Computed<number>;
  cloudCostManagementHostCountAvg?: number | Computed<number>;
  cloudCostManagementOciHostCountAvg?: number | Computed<number>;
  cloudSiemEventsSum?: number | Computed<number>;
  cloudSiemIndexedLogsSum?: number | Computed<number>;
  codeAnalysisSaCommittersHwm?: number | Computed<number>;
  codeAnalysisScaCommittersHwm?: number | Computed<number>;
  codeSecurityHostTop99p?: number | Computed<number>;
  containerAvg?: number | Computed<number>;
  containerExclAgentAvg?: number | Computed<number>;
  containerHwm?: number | Computed<number>;
  csmContainerEnterpriseComplianceCountSum?: number | Computed<number>;
  csmContainerEnterpriseCwsCountSum?: number | Computed<number>;
  csmContainerEnterpriseTotalCountSum?: number | Computed<number>;
  csmHostEnterpriseAasHostCountTop99p?: number | Computed<number>;
  csmHostEnterpriseAwsHostCountTop99p?: number | Computed<number>;
  csmHostEnterpriseAzureHostCountTop99p?: number | Computed<number>;
  csmHostEnterpriseComplianceHostCountTop99p?: number | Computed<number>;
  csmHostEnterpriseCwsHostCountTop99p?: number | Computed<number>;
  csmHostEnterpriseGcpHostCountTop99p?: number | Computed<number>;
  csmHostEnterpriseOciHostCountTop99p?: number | Computed<number>;
  csmHostEnterpriseTotalHostCountTop99p?: number | Computed<number>;
  csmHostProHostsAgentlessScannersSum?: number | Computed<number>;
  csmHostProHostsAgentlessScannersTop99p?: number | Computed<number>;
  csmHostProOciHostCountTop99p?: number | Computed<number>;
  cspmAasHostTop99p?: number | Computed<number>;
  cspmAwsHostTop99p?: number | Computed<number>;
  cspmAzureHostTop99p?: number | Computed<number>;
  cspmContainerAvg?: number | Computed<number>;
  cspmContainerHwm?: number | Computed<number>;
  cspmGcpHostTop99p?: number | Computed<number>;
  cspmHostTop99p?: number | Computed<number>;
  cspmHostsAgentlessScannersSum?: number | Computed<number>;
  cspmHostsAgentlessScannersTop99p?: number | Computed<number>;
  customHistoricalTsAvg?: number | Computed<number>;
  customLiveTsAvg?: number | Computed<number>;
  customTsAvg?: number | Computed<number>;
  cwsContainerCountAvg?: number | Computed<number>;
  cwsFargateTaskAvg?: number | Computed<number>;
  cwsHostTop99p?: number | Computed<number>;
  dataJobsMonitoringHostHrSum?: number | Computed<number>;
  dataStreamMonitoringHostCountSum?: number | Computed<number>;
  dataStreamMonitoringHostCountTop99p?: number | Computed<number>;
  dbmHostTop99pSum?: number | Computed<number>;
  dbmQueriesAvgSum?: number | Computed<number>;
  doJobsMonitoringOrchestratorsJobHoursSum?: number | Computed<number>;
  ephInfraHostAgentSum?: number | Computed<number>;
  ephInfraHostAlibabaSum?: number | Computed<number>;
  ephInfraHostAwsSum?: number | Computed<number>;
  ephInfraHostAzureSum?: number | Computed<number>;
  ephInfraHostBasicInfraBasicAgentSum?: number | Computed<number>;
  ephInfraHostBasicInfraBasicVsphereSum?: number | Computed<number>;
  ephInfraHostBasicSum?: number | Computed<number>;
  ephInfraHostEntSum?: number | Computed<number>;
  ephInfraHostGcpSum?: number | Computed<number>;
  ephInfraHostHerokuSum?: number | Computed<number>;
  ephInfraHostOnlyAasSum?: number | Computed<number>;
  ephInfraHostOnlyVsphereSum?: number | Computed<number>;
  ephInfraHostOpentelemetryApmSum?: number | Computed<number>;
  ephInfraHostOpentelemetrySum?: number | Computed<number>;
  ephInfraHostProSum?: number | Computed<number>;
  ephInfraHostProplusSum?: number | Computed<number>;
  ephInfraHostProxmoxSum?: number | Computed<number>;
  errorTrackingApmErrorEventsSum?: number | Computed<number>;
  errorTrackingErrorEventsSum?: number | Computed<number>;
  errorTrackingEventsSum?: number | Computed<number>;
  errorTrackingRumErrorEventsSum?: number | Computed<number>;
  eventManagementCorrelationCorrelatedEventsSum?: number | Computed<number>;
  eventManagementCorrelationCorrelatedRelatedEventsSum?: number | Computed<number>;
  eventManagementCorrelationSum?: number | Computed<number>;
  fargateContainerProfilerProfilingFargateAvg?: number | Computed<number>;
  fargateContainerProfilerProfilingFargateEksAvg?: number | Computed<number>;
  fargateTasksCountAvg?: number | Computed<number>;
  fargateTasksCountHwm?: number | Computed<number>;
  featureFlagsConfigRequestsSum?: number | Computed<number>;
  flexLogsComputeLargeAvg?: number | Computed<number>;
  flexLogsComputeMediumAvg?: number | Computed<number>;
  flexLogsComputeSmallAvg?: number | Computed<number>;
  flexLogsComputeXlargeAvg?: number | Computed<number>;
  flexLogsComputeXsmallAvg?: number | Computed<number>;
  flexLogsStarterAvg?: number | Computed<number>;
  flexLogsStarterStorageIndexAvg?: number | Computed<number>;
  flexLogsStarterStorageRetentionAdjustmentAvg?: number | Computed<number>;
  flexStoredLogsAvg?: number | Computed<number>;
  forwardingEventsBytesSum?: number | Computed<number>;
  gcpHostTop99p?: number | Computed<number>;
  herokuHostTop99p?: number | Computed<number>;
  id?: string | Computed<string>;
  incidentManagementMonthlyActiveUsersHwm?: number | Computed<number>;
  incidentManagementSeatsHwm?: number | Computed<number>;
  indexedEventsCountSum?: number | Computed<number>;
  indexedPointsSum?: number | Computed<number>;
  infraCpuAvg?: number | Computed<number>;
  infraCpuDefaultInfraHostVcpuAgentAvg?: number | Computed<number>;
  infraCpuDefaultInfraHostVcpuAgentBasicAvg?: number | Computed<number>;
  infraCpuDefaultInfraHostVcpuAgentBasicSum?: number | Computed<number>;
  infraCpuDefaultInfraHostVcpuAgentSum?: number | Computed<number>;
  infraCpuDefaultInfraHostVcpuAwsAvg?: number | Computed<number>;
  infraCpuDefaultInfraHostVcpuAwsSum?: number | Computed<number>;
  infraCpuDefaultInfraHostVcpuAzureAvg?: number | Computed<number>;
  infraCpuDefaultInfraHostVcpuAzureSum?: number | Computed<number>;
  infraCpuDefaultInfraHostVcpuGcpAvg?: number | Computed<number>;
  infraCpuDefaultInfraHostVcpuGcpSum?: number | Computed<number>;
  infraCpuDefaultInfraHostVcpuNutanixAvg?: number | Computed<number>;
  infraCpuDefaultInfraHostVcpuNutanixBasicAvg?: number | Computed<number>;
  infraCpuDefaultInfraHostVcpuNutanixBasicSum?: number | Computed<number>;
  infraCpuDefaultInfraHostVcpuNutanixSum?: number | Computed<number>;
  infraCpuDefaultInfraHostVcpuOpentelemetryAvg?: number | Computed<number>;
  infraCpuDefaultInfraHostVcpuOpentelemetrySum?: number | Computed<number>;
  infraCpuObservedInfraHostVcpuAgentAvg?: number | Computed<number>;
  infraCpuObservedInfraHostVcpuAgentSum?: number | Computed<number>;
  infraCpuObservedInfraHostVcpuAwsAvg?: number | Computed<number>;
  infraCpuObservedInfraHostVcpuAwsSum?: number | Computed<number>;
  infraCpuObservedInfraHostVcpuAzureAvg?: number | Computed<number>;
  infraCpuObservedInfraHostVcpuAzureSum?: number | Computed<number>;
  infraCpuObservedInfraHostVcpuGcpAvg?: number | Computed<number>;
  infraCpuObservedInfraHostVcpuGcpSum?: number | Computed<number>;
  infraCpuObservedInfraHostVcpuNutanixAvg?: number | Computed<number>;
  infraCpuObservedInfraHostVcpuNutanixSum?: number | Computed<number>;
  infraCpuObservedInfraHostVcpuOpentelemetryAvg?: number | Computed<number>;
  infraCpuObservedInfraHostVcpuOpentelemetrySum?: number | Computed<number>;
  infraCpuSum?: number | Computed<number>;
  infraEdgeMonitoringDevicesTop99p?: number | Computed<number>;
  infraHostBasicInfraBasicAgentTop99p?: number | Computed<number>;
  infraHostBasicInfraBasicVsphereTop99p?: number | Computed<number>;
  infraHostBasicTop99p?: number | Computed<number>;
  infraHostTop99p?: number | Computed<number>;
  infraStorageMgmtObjectsCountAvg?: number | Computed<number>;
  ingestPointsSum?: number | Computed<number>;
  ingestedEventsBytesSum?: number | Computed<number>;
  iotApmHostSum?: number | Computed<number>;
  iotApmHostTop99p?: number | Computed<number>;
  iotDeviceAggSum?: number | Computed<number>;
  iotDeviceTop99pSum?: number | Computed<number>;
  llmObservability15dayRetentionSpansSum?: number | Computed<number>;
  llmObservability30dayRetentionSpansSum?: number | Computed<number>;
  llmObservability60dayRetentionSpansSum?: number | Computed<number>;
  llmObservability90dayRetentionSpansSum?: number | Computed<number>;
  llmObservabilityMinSpendSum?: number | Computed<number>;
  llmObservabilitySum?: number | Computed<number>;
  logsArchiveSearchGbScannedSum?: number | Computed<number>;
  metricNamesSum?: number | Computed<number>;
  mobileRumLiteSessionCountSum?: number | Computed<number>;
  mobileRumSessionCountAndroidSum?: number | Computed<number>;
  mobileRumSessionCountFlutterSum?: number | Computed<number>;
  mobileRumSessionCountIosSum?: number | Computed<number>;
  mobileRumSessionCountReactnativeSum?: number | Computed<number>;
  mobileRumSessionCountRokuSum?: number | Computed<number>;
  mobileRumSessionCountSum?: number | Computed<number>;
  mobileRumUnitsSum?: number | Computed<number>;
  name?: string | Computed<string>;
  ndmNetflowEventsSum?: number | Computed<number>;
  netflowIndexedEventsCountSum?: number | Computed<number>;
  networkDeviceWirelessTop99p?: number | Computed<number>;
  networkPathSum?: number | Computed<number>;
  npmHostTop99p?: number | Computed<number>;
  observabilityPipelinesBytesProcessedSum?: number | Computed<number>;
  ociHostSum?: number | Computed<number>;
  ociHostTop99p?: number | Computed<number>;
  onCallSeatHwm?: number | Computed<number>;
  onlineArchiveEventsCountSum?: number | Computed<number>;
  opentelemetryApmHostTop99p?: number | Computed<number>;
  opentelemetryHostTop99p?: number | Computed<number>;
  productAnalyticsSum?: number | Computed<number>;
  profilingAasCountTop99p?: number | Computed<number>;
  profilingHostTop99p?: number | Computed<number>;
  proxmoxHostSum?: number | Computed<number>;
  proxmoxHostTop99p?: number | Computed<number>;
  publicId?: string | Computed<string>;
  publishedAppHwm?: number | Computed<number>;
  region?: string | Computed<string>;
  rumBrowserAndMobileSessionCount?: number | Computed<number>;
  rumBrowserLegacySessionCountSum?: number | Computed<number>;
  rumBrowserLiteSessionCountSum?: number | Computed<number>;
  rumBrowserReplaySessionCountSum?: number | Computed<number>;
  rumIndexedSessionsSum?: number | Computed<number>;
  rumIngestedSessionsSum?: number | Computed<number>;
  rumLiteSessionCountSum?: number | Computed<number>;
  rumMobileLegacySessionCountAndroidSum?: number | Computed<number>;
  rumMobileLegacySessionCountFlutterSum?: number | Computed<number>;
  rumMobileLegacySessionCountIosSum?: number | Computed<number>;
  rumMobileLegacySessionCountReactnativeSum?: number | Computed<number>;
  rumMobileLegacySessionCountRokuSum?: number | Computed<number>;
  rumMobileLiteSessionCountAndroidSum?: number | Computed<number>;
  rumMobileLiteSessionCountFlutterSum?: number | Computed<number>;
  rumMobileLiteSessionCountIosSum?: number | Computed<number>;
  rumMobileLiteSessionCountKotlinmultiplatformSum?: number | Computed<number>;
  rumMobileLiteSessionCountReactnativeSum?: number | Computed<number>;
  rumMobileLiteSessionCountRokuSum?: number | Computed<number>;
  rumMobileLiteSessionCountUnitySum?: number | Computed<number>;
  rumMobileReplaySessionCountAndroidSum?: number | Computed<number>;
  rumMobileReplaySessionCountIosSum?: number | Computed<number>;
  rumMobileReplaySessionCountKotlinmultiplatformSum?: number | Computed<number>;
  rumMobileReplaySessionCountReactnativeSum?: number | Computed<number>;
  rumReplaySessionCountSum?: number | Computed<number>;
  rumSessionCountSum?: number | Computed<number>;
  rumSessionReplayAddOnSum?: number | Computed<number>;
  rumTotalSessionCountSum?: number | Computed<number>;
  rumUnitsSum?: number | Computed<number>;
  scaFargateCountAvg?: number | Computed<number>;
  scaFargateCountHwm?: number | Computed<number>;
  sdsApmScannedBytesSum?: number | Computed<number>;
  sdsEventsScannedBytesSum?: number | Computed<number>;
  sdsLogsScannedBytesSum?: number | Computed<number>;
  sdsRumScannedBytesSum?: number | Computed<number>;
  sdsTotalScannedBytesSum?: number | Computed<number>;
  serverlessAppsApmApmAzureAppserviceInstancesAvg?: number | Computed<number>;
  serverlessAppsApmApmAzureAzurefunctionInstancesAvg?: number | Computed<number>;
  serverlessAppsApmApmAzureContainerappInstancesAvg?: number | Computed<number>;
  serverlessAppsApmApmFargateEcsTasksAvg?: number | Computed<number>;
  serverlessAppsApmApmGcpCloudfunctionInstancesAvg?: number | Computed<number>;
  serverlessAppsApmApmGcpCloudrunInstancesAvg?: number | Computed<number>;
  serverlessAppsApmApmGcpGkeAutopilotPodsAvg?: number | Computed<number>;
  serverlessAppsApmAvg?: number | Computed<number>;
  serverlessAppsApmExclFargateApmAzureAppserviceInstancesAvg?: number | Computed<number>;
  serverlessAppsApmExclFargateApmAzureAzurefunctionInstancesAvg?: number | Computed<number>;
  serverlessAppsApmExclFargateApmAzureContainerappInstancesAvg?: number | Computed<number>;
  serverlessAppsApmExclFargateApmGcpCloudfunctionInstancesAvg?: number | Computed<number>;
  serverlessAppsApmExclFargateApmGcpCloudrunInstancesAvg?: number | Computed<number>;
  serverlessAppsApmExclFargateApmGcpGkeAutopilotPodsAvg?: number | Computed<number>;
  serverlessAppsApmExclFargateAvg?: number | Computed<number>;
  serverlessAppsAzureContainerAppInstancesAvg?: number | Computed<number>;
  serverlessAppsAzureCountAvg?: number | Computed<number>;
  serverlessAppsAzureFunctionAppInstancesAvg?: number | Computed<number>;
  serverlessAppsAzureWebAppInstancesAvg?: number | Computed<number>;
  serverlessAppsDsmFargateTasksAvg?: number | Computed<number>;
  serverlessAppsEcsAvg?: number | Computed<number>;
  serverlessAppsEksAvg?: number | Computed<number>;
  serverlessAppsExclFargateAvg?: number | Computed<number>;
  serverlessAppsExclFargateAzureContainerAppInstancesAvg?: number | Computed<number>;
  serverlessAppsExclFargateAzureFunctionAppInstancesAvg?: number | Computed<number>;
  serverlessAppsExclFargateAzureWebAppInstancesAvg?: number | Computed<number>;
  serverlessAppsExclFargateGoogleCloudFunctionsInstancesAvg?: number | Computed<number>;
  serverlessAppsExclFargateGoogleCloudRunInstancesAvg?: number | Computed<number>;
  serverlessAppsExclFargateInfraGcpGkeAutopilotPodsAvg?: number | Computed<number>;
  serverlessAppsGoogleCloudFunctionsInstancesAvg?: number | Computed<number>;
  serverlessAppsGoogleCloudRunInstancesAvg?: number | Computed<number>;
  serverlessAppsGoogleCountAvg?: number | Computed<number>;
  serverlessAppsInfraGcpGkeAutopilotPodsAvg?: number | Computed<number>;
  serverlessAppsTotalCountAvg?: number | Computed<number>;
  siem12moRetentionSum?: number | Computed<number>;
  siem6moRetentionSum?: number | Computed<number>;
  siemAnalyzedLogsAddOnCountSum?: number | Computed<number>;
  snmpDeviceCountSum?: number | Computed<number>;
  snmpDeviceCountTop99p?: number | Computed<number>;
  syntheticsBrowserCheckCallsCountSum?: number | Computed<number>;
  syntheticsCheckCallsCountSum?: number | Computed<number>;
  syntheticsMobileTestRunsSum?: number | Computed<number>;
  syntheticsParallelTestingMaxSlotsHwm?: number | Computed<number>;
  traceSearchIndexedEventsCountSum?: number | Computed<number>;
  twolIngestedEventsBytesSum?: number | Computed<number>;
  universalServiceMonitoringHostTop99p?: number | Computed<number>;
  vsphereHostTop99p?: number | Computed<number>;
  vulnManagementHostCountTop99p?: number | Computed<number>;
  workflowExecutionsUsageSum?: number | Computed<number>;
}

export interface SummaryResponse_Usage {
  agentHostTop99p?: number | Computed<number>;
  aiCreditsAgentBuilderAiCreditsSum?: number | Computed<number>;
  aiCreditsBitsAssistantAiCreditsSum?: number | Computed<number>;
  aiCreditsBitsDevAiCreditsSum?: number | Computed<number>;
  ...
  dataStreamMonitoringHostCountTop99p?: number | Computed<number>;
  date?: string | Computed<string>;
  dbmHostTop99p?: number | Computed<number>;
  dbmQueriesCountAvg?: number | Computed<number>;
  doJobsMonitoringOrchestratorsJobHoursSum?: number | Computed<number>;
  ephInfraHostAgentSum?: number | Computed<number>;
  ephInfraHostAlibabaSum?: number | Computed<number>;
  ephInfraHostAwsSum?: number | Computed<number>;
  ...
  iotApmHostSum?: number | Computed<number>;
  iotApmHostTop99p?: number | Computed<number>;
  iotDeviceSum?: number | Computed<number>;
  iotDeviceTop99p?: number | Computed<number>;
  llmObservability15dayRetentionSpansSum?: number | Computed<number>;
  llmObservability30dayRetentionSpansSum?: number | Computed<number>;
  llmObservability60dayRetentionSpansSum?: number | Computed<number>;
  llmObservability90dayRetentionSpansSum?: number | Computed<number>;
  ...
  opentelemetryApmHostTop99p?: number | Computed<number>;
  opentelemetryHostTop99p?: number | Computed<number>;
  orgs?: SummaryResponse_Usage_Orgs[] | Computed<SummaryResponse_Usage_Orgs[]>;
  productAnalyticsSum?: number | Computed<number>;
  profilingAasCountTop99p?: number | Computed<number>;
  profilingHostTop99p?: number | Computed<number>;
  proxmoxHostSum?: number | Computed<number>;
...
export interface SummaryResponseConfig {
  endMonth?: string | Computed<string>;
  includeConnectedAccounts?: boolean | Computed<boolean>;
  includeOrgDetails?: boolean | Computed<boolean>;
  startMonth: string | Computed<string>;
}

export interface SummaryResponseAttrs {
  ...
  logsByRetention: SummaryResponse_LogsByRetention;
...
export const SummaryResponse: DataSourceBinding<SummaryResponseConfig, SummaryResponseAttrs> = {
  wireType: "datadog_usage_summary_response",
  fields: {
    endMonth: "end_month",
    includeConnectedAccounts: "include_connected_accounts",
    includeOrgDetails: "include_org_details",

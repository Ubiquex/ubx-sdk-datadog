...
class TestDetailsWithoutStepsList_Tests_Config_Assertions:
    code: Any = None
    operator: Any = None
    property: Any = None
    target: Any = None
...
@dataclasses.dataclass
class TestDetailsWithoutStepsList_Tests_Config_ConfigVariables:
    example: Any = None
    id: Any = None
    name: Any = None
    pattern: Any = None
...
@dataclasses.dataclass
class TestDetailsWithoutStepsList_Tests_Config_Request_BasicAuth_AddClaims:
    exp: Any = None
    iat: Any = None

@dataclasses.dataclass
class TestDetailsWithoutStepsList_Tests_Config_Request_BasicAuth:
    access_key: Any = None
...
@dataclasses.dataclass
class TestDetailsWithoutStepsList_Tests_Config_Request_Certificate_Cert:
    content: Any = None
    filename: Any = None
    updated_at: Any = None

@dataclasses.dataclass
class TestDetailsWithoutStepsList_Tests_Config_Request_Certificate:
    cert: Any = None
    key: Any = None

@dataclasses.dataclass
class TestDetailsWithoutStepsList_Tests_Config_Request_Files:
    bucket_key: Any = None
    content: Any = None
    encoding: Any = None
    name: Any = None
...
@dataclasses.dataclass
class TestDetailsWithoutStepsList_Tests_Config_Request_Proxy:
    headers: Any = None
    url: Any = None

@dataclasses.dataclass
class TestDetailsWithoutStepsList_Tests_Config_Request:
...
@dataclasses.dataclass
class TestDetailsWithoutStepsList_Tests_Config:
    assertions: Any = None
...
@dataclasses.dataclass
class TestDetailsWithoutStepsList_Tests_Creator:
    email: Any = None
    handle: Any = None
    name: Any = None

@dataclasses.dataclass
class TestDetailsWithoutStepsList_Tests_Options_Ci:
    execution_rule: Any = None

@dataclasses.dataclass
class TestDetailsWithoutStepsList_Tests_Options_MonitorOptions:
...
@dataclasses.dataclass
class TestDetailsWithoutStepsList_Tests_Options_Retry:
    count: Any = None
    interval: Any = None

@dataclasses.dataclass
class TestDetailsWithoutStepsList_Tests_Options_RumSettings:
    application_id: Any = None
    client_token_id: Any = None
    is_enabled: Any = None

@dataclasses.dataclass
class TestDetailsWithoutStepsList_Tests_Options_Scheduling_Timeframes:
    day: Any = None
    from_: Any = None
    to: Any = None

@dataclasses.dataclass
class TestDetailsWithoutStepsList_Tests_Options_Scheduling:
    timeframes: Any = None
    timezone: Any = None

@dataclasses.dataclass
class TestDetailsWithoutStepsList_Tests_Options:
...
@dataclasses.dataclass
class TestDetailsWithoutStepsList_Tests:
    config: Any = None
    creator: Any = None
    locations: Any = None
    message: Any = None
...
@dataclasses.dataclass
class TestDetailsWithoutStepsListConfig:
    page_number: Any = None
    page_size: Any = None

@dataclasses.dataclass
class TestDetailsWithoutStepsListAttrs:
    page_number: Any = None
    page_size: Any = None
    # Array of Synthetic tests configuration.
    tests: Any = None

TestDetailsWithoutStepsList = ubx.DataSourceBinding(
    wire_type="datadog_synthetics_test_details_without_steps_list",
    fields={

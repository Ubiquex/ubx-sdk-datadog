...
class ApiPayloadData_Data_Attributes:
    created_at: Any = None
...
@dataclasses.dataclass
class ApiPayloadData_Data:
    attributes: Any = None
    id: Any = None
    type: Any = None

@dataclasses.dataclass
class ApiPayloadData_Meta_Page:
...
@dataclasses.dataclass
class ApiPayloadData_Meta_Schema_Fields:
    name: Any = None
    type: Any = None

@dataclasses.dataclass
class ApiPayloadData_Meta_Schema:
...
ApiPayloadData = ubx.DataSourceBinding(
    wire_type="datadog_item_api_payload_data",
    fields={

...
class ApiPayloadDataList_Data_Attributes:
    created_at: Any = None
...
@dataclasses.dataclass
class ApiPayloadDataList_Data:
    attributes: Any = None
    id: Any = None
    type: Any = None

@dataclasses.dataclass
class ApiPayloadDataList_Meta_Page:
...
@dataclasses.dataclass
class ApiPayloadDataList_Meta_Schema_Fields:
    name: Any = None
    type: Any = None

@dataclasses.dataclass
class ApiPayloadDataList_Meta_Schema:
...
@dataclasses.dataclass
class ApiPayloadDataListConfig:
...
ApiPayloadDataList = ubx.DataSourceBinding(
    wire_type="datadog_item_api_payload_data_list",
    fields={

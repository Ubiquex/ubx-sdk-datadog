...
class DataList_Data_Relationships_CurrentOrg_Data:
...
@dataclasses.dataclass
class DataList_Data_Relationships_CurrentOrg:
    # Reference to an organization resource.
    data: Any = None

@dataclasses.dataclass
class DataList_Data_Relationships_ManagedOrgs:
    # List of managed organization references.
    data: Any = None

@dataclasses.dataclass
class DataList_Data_Relationships:
...
@dataclasses.dataclass
class DataList_Included_Attributes:
    created_at: Any = None
...
DataList = ubx.DataSourceBinding(
    wire_type="datadog_org_data_list",
    fields={
    },
)

...
class FlagListItemList_Data_Attributes_FeatureFlagEnvironments:
...
@dataclasses.dataclass
class FlagListItemList_Data_Attributes_Variants:
    created_at: Any = None
    id: Any = None
    key: Any = None
    name: Any = None
...
@dataclasses.dataclass
class FlagListItemList_Data_Attributes:
...
@dataclasses.dataclass
class FlagListItemList_Data:
    attributes: Any = None
    id: Any = None
    type: Any = None

@dataclasses.dataclass
class FlagListItemList_Meta_Page:
...
@dataclasses.dataclass
class FlagListItemList_Meta:
    # Pagination metadata for feature flags list responses.
    page: Any = None

@dataclasses.dataclass
class FlagListItemListConfig:
...
FlagListItemList = ubx.DataSourceBinding(
    wire_type="datadog_feature_flag_list_item_list",
    fields={

...
class AssetResponseIncluded_Data_Relationships_Dashboards_Data:
    id: Any = None
    type: Any = None

@dataclasses.dataclass
class AssetResponseIncluded_Data_Relationships_Dashboards:
    # A list of dashboards that can be referenced in the `included` data.
    data: Any = None

@dataclasses.dataclass
class AssetResponseIncluded_Data_Relationships:
...
@dataclasses.dataclass
class AssetResponseIncluded_Data:
...
@dataclasses.dataclass
class AssetResponseIncluded_Included_Attributes:
    popularity: Any = None
    tags: Any = None
    title: Any = None
    url: Any = None
...
@dataclasses.dataclass
class AssetResponseIncluded_Included:
    attributes: Any = None
    id: Any = None
    type: Any = None

@dataclasses.dataclass
class AssetResponseIncludedConfig:
    metric_name: Any = None

@dataclasses.dataclass
class AssetResponseIncludedAttrs:
...
AssetResponseIncluded = ubx.DataSourceBinding(
    wire_type="datadog_metric_asset_response_included",
    fields={

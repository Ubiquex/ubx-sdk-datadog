...
class AssetResponseIncludedList_Data_Relationships_Dashboards_Data:
    id: Any = None
    type: Any = None

@dataclasses.dataclass
class AssetResponseIncludedList_Data_Relationships_Dashboards:
    # A list of dashboards that can be referenced in the `included` data.
    data: Any = None

@dataclasses.dataclass
class AssetResponseIncludedList_Data_Relationships:
...
@dataclasses.dataclass
class AssetResponseIncludedList_Data:
...
@dataclasses.dataclass
class AssetResponseIncludedList_Included_Attributes:
    popularity: Any = None
    tags: Any = None
    title: Any = None
    url: Any = None
...
@dataclasses.dataclass
class AssetResponseIncludedList_Included:
    attributes: Any = None
    id: Any = None
    type: Any = None

@dataclasses.dataclass
class AssetResponseIncludedListConfig:
    metric_name: Any = None

@dataclasses.dataclass
class AssetResponseIncludedListAttrs:
...
AssetResponseIncludedList = ubx.DataSourceBinding(
    wire_type="datadog_metric_asset_response_included_list",
    fields={

...
@dataclasses.dataclass
class ResponseIncludedItemList_Data_Relationships_Org_Data:
...
@dataclasses.dataclass
class ResponseIncludedItemList_Data_Relationships_Org:
    # Relationship to organization object.
    data: Any = None

@dataclasses.dataclass
class ResponseIncludedItemList_Data_Relationships_OtherOrgs:
    # Relationships to organization objects.
    data: Any = None

@dataclasses.dataclass
class ResponseIncludedItemList_Data_Relationships:
...
ResponseIncludedItemList = ubx.DataSourceBinding(
    wire_type="datadog_user_response_included_item_list",
    fields={
    },
)

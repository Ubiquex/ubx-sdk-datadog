...
class DeletionResponseItemList_Data_Attributes:
    created_at: Any = None
    created_by: Any = None
...
@dataclasses.dataclass
class DeletionResponseItemList_Data:
    attributes: Any = None
    id: Any = None
    type: Any = None

@dataclasses.dataclass
class DeletionResponseItemList_Meta:
...
@dataclasses.dataclass
class DeletionResponseItemListConfig:
    next_page: Any = None
    page_size: Any = None
    product: Any = None
    query: Any = None
...
@dataclasses.dataclass
class DeletionResponseItemListAttrs:
...
DeletionResponseItemList = ubx.DataSourceBinding(
    wire_type="datadog_data_deletion_response_item_list",
    fields={

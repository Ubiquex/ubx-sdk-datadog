...
class OnCallRespondersIncluded_Data_Relationships_Escalations_Data:
    id: Any = None
    type: Any = None

@dataclasses.dataclass
class OnCallRespondersIncluded_Data_Relationships_Escalations:
...
@dataclasses.dataclass
class OnCallRespondersIncluded_Included_Relationships_Org:
    data: Any = None
...
OnCallRespondersIncluded = ubx.DataSourceBinding(
    wire_type="datadog_team_on_call_responders_included",
    fields={

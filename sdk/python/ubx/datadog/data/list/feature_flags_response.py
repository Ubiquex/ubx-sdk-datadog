...
class FeatureFlagsResponse_Data_Attributes_FeatureFlagEnvironments:
...
@dataclasses.dataclass
class FeatureFlagsResponse_Data_Attributes_Variants:
    created_at: Any = None
    id: Any = None
    key: Any = None
    name: Any = None
...
@dataclasses.dataclass
class FeatureFlagsResponse_Data_Attributes:
...
@dataclasses.dataclass
class FeatureFlagsResponse_Data:
    attributes: Any = None
    id: Any = None
    type: Any = None

@dataclasses.dataclass
class FeatureFlagsResponse_Meta_Page:
...
@dataclasses.dataclass
class FeatureFlagsResponse_Meta:
    # Pagination metadata for feature flags list responses.
    page: Any = None

@dataclasses.dataclass
class FeatureFlagsResponseConfig:
...
@dataclasses.dataclass
class FeatureFlagsResponseAttrs:
...
FeatureFlagsResponse = ubx.DataSourceBinding(
    wire_type="datadog_list_feature_flags_response",
    fields={

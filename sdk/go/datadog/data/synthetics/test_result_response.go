...
type TestResultResponse_Data_Attributes_Batch struct {
	// Batch identifier.
	Id any
}

type TestResultResponse_Data_Attributes_Ci_Pipeline struct {
	// Pipeline identifier.
	Id any
	// Pipeline name.
	Name any
...
type TestResultResponse_Data_Attributes_Ci_Provider struct {
	// Provider name.
	Name any
}

type TestResultResponse_Data_Attributes_Ci struct {
...
type TestResultResponse_Data_Attributes_Device_Browser struct {
...
type TestResultResponse_Data_Attributes_Device_Platform struct {
...
type TestResultResponse_Data_Attributes_Device_Resolution struct {
...
type TestResultResponse_Data_Attributes_Device struct {
...
type TestResultResponse_Data_Attributes_Git_Commit_Author struct {
...
type TestResultResponse_Data_Attributes_Git_Commit struct {
...
type TestResultResponse_Data_Attributes_Git struct {
	// Git branch name.
	Branch any
...
type TestResultResponse_Data_Attributes_Location struct {
...
type TestResultResponse_Data_Attributes_Result_Assertions struct {
	Actual any
	ErrorMessage any
	Expected any
	Operator any
...
type TestResultResponse_Data_Attributes_Result_BucketKeys struct {
...
type TestResultResponse_Data_Attributes_Result_Cert_Valid struct {
...
type TestResultResponse_Data_Attributes_Result_Cert struct {
...
type TestResultResponse_Data_Attributes_Result_DnsResolution struct {
...
type TestResultResponse_Data_Attributes_Result_Failure struct {
...
type TestResultResponse_Data_Attributes_Result_Handshake_Request_Files struct {
	BucketKey any
	Encoding any
	Name any
	Size any
...
type TestResultResponse_Data_Attributes_Result_Handshake_Request struct {
...
type TestResultResponse_Data_Attributes_Result_Handshake_Response_Cdn_Cache struct {
...
type TestResultResponse_Data_Attributes_Result_Handshake_Response_Cdn struct {
...
type TestResultResponse_Data_Attributes_Result_Handshake_Response_Close struct {
...
type TestResultResponse_Data_Attributes_Result_Handshake_Response_Healthcheck struct {
...
type TestResultResponse_Data_Attributes_Result_Handshake_Response_Records struct {
	Type any
	Values any
}

type TestResultResponse_Data_Attributes_Result_Handshake_Response_Redirects struct {
	Location any
	StatusCode any
}

type TestResultResponse_Data_Attributes_Result_Handshake_Response struct {
...
type TestResultResponse_Data_Attributes_Result_Handshake struct {
...
type TestResultResponse_Data_Attributes_Result_Netpath_Destination struct {
...
type TestResultResponse_Data_Attributes_Result_Netpath_Hops struct {
	Hostname any
	IpAddress any
	Reachable any
	Rtt any
...
type TestResultResponse_Data_Attributes_Result_Netpath_Source struct {
	// Hostname of the endpoint.
	Hostname any
}

type TestResultResponse_Data_Attributes_Result_Netpath struct {
...
type TestResultResponse_Data_Attributes_Result_Netstats_Hops struct {
...
type TestResultResponse_Data_Attributes_Result_Netstats struct {
...
type TestResultResponse_Data_Attributes_Result_Ocsp_Certificate struct {
...
type TestResultResponse_Data_Attributes_Result_Ocsp_Updates struct {
...
type TestResultResponse_Data_Attributes_Result_Ocsp struct {
...
type TestResultResponse_Data_Attributes_Result_Ping_Routers struct {
	Ip any
	ResolvedHost any
}

type TestResultResponse_Data_Attributes_Result_Ping struct {
	// Target hostname.
	Host any
	// Latency statistics for a network probe.
	Latency any
...
type TestResultResponse_Data_Attributes_Result_Steps_AssertionResult struct {
	Actual any
	CheckType any
	Expected any
...
type TestResultResponse_Data_Attributes_Result_Steps_Bounds struct {
	Height any
	Width any
	X any
	Y any
...
type TestResultResponse_Data_Attributes_Result_Steps_BrowserErrors struct {
	Description any
	Method any
	Name any
	Status any
...
type TestResultResponse_Data_Attributes_Result_Steps_CdnResources struct {
	Cdn any
	ResolvedIp any
	Timestamp any
	Timings any
...
type TestResultResponse_Data_Attributes_Result_Steps_ElementUpdates struct {
	MultiLocator any
	TargetOuterHtml any
	Version any
}

type TestResultResponse_Data_Attributes_Result_Steps_ExtractedValue struct {
	Err any
	ErrorMessage any
	Example any
	Id any
...
type TestResultResponse_Data_Attributes_Result_Steps_Retries struct {
}

type TestResultResponse_Data_Attributes_Result_Steps_RumContext struct {
	ApplicationId any
	SessionId any
	ViewId any
}

type TestResultResponse_Data_Attributes_Result_Steps_SubStep struct {
	Level any
	ParentStep any
	ParentTest any
}

type TestResultResponse_Data_Attributes_Result_Steps_SubTest struct {
	Id any
	PlayingTab any
	RumContext any
}

type TestResultResponse_Data_Attributes_Result_Steps_Tabs struct {
	Focused any
	Title any
	Url any
}

type TestResultResponse_Data_Attributes_Result_Steps_Variables struct {
	Config any
	Extracted any
}

type TestResultResponse_Data_Attributes_Result_Steps_VitalsMetrics struct {
	Cls any
	Fcp any
	Inp any
	Lcp any
...
type TestResultResponse_Data_Attributes_Result_Steps_Warnings struct {
	ElementBounds any
	Message any
	Type any
}

type TestResultResponse_Data_Attributes_Result_Steps struct {
	AllowFailure any
	ApiTest any
	AssertionResult any
	Assertions any
...
type TestResultResponse_Data_Attributes_Result_Trace struct {
...
type TestResultResponse_Data_Attributes_Result_Turns_Steps struct {
	BucketKeys any
	Config any
}

type TestResultResponse_Data_Attributes_Result_Turns struct {
	BucketKeys any
	Name any
	Reasoning any
	Status any
...
type TestResultResponse_Data_Attributes_Result struct {
...
type TestResultResponse_Data_Attributes struct {
...
type TestResultResponse_Data_Relationships_Test_Data struct {
...
type TestResultResponse_Data_Relationships_Test struct {
	// Data for the test relationship.
	Data any
}

type TestResultResponse_Data_Relationships struct {
	// Relationship to the Synthetic test.
	Test any
}

type TestResultResponse_Data struct {
...
type TestResultResponse_Included struct {
	Attributes any
	Id any
	Type any
}

type TestResultResponseConfig struct {
	EventId any
	PublicId any
	ResultId any
	Timestamp any
...
type TestResultResponseAttrs struct {
...
var TestResultResponse = ubx.DataSourceBinding{

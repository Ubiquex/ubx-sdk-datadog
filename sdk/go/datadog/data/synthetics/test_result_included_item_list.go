...
type TestResultIncludedItemList_Data_Attributes_Batch struct {
	// Batch identifier.
	Id any
}

type TestResultIncludedItemList_Data_Attributes_Ci_Pipeline struct {
	// Pipeline identifier.
	Id any
	// Pipeline name.
	Name any
...
type TestResultIncludedItemList_Data_Attributes_Ci_Provider struct {
	// Provider name.
	Name any
}

type TestResultIncludedItemList_Data_Attributes_Ci struct {
...
type TestResultIncludedItemList_Data_Attributes_Device_Browser struct {
...
type TestResultIncludedItemList_Data_Attributes_Device_Platform struct {
...
type TestResultIncludedItemList_Data_Attributes_Device_Resolution struct {
...
type TestResultIncludedItemList_Data_Attributes_Device struct {
...
type TestResultIncludedItemList_Data_Attributes_Git_Commit_Author struct {
...
type TestResultIncludedItemList_Data_Attributes_Git_Commit struct {
...
type TestResultIncludedItemList_Data_Attributes_Git struct {
	// Git branch name.
	Branch any
...
type TestResultIncludedItemList_Data_Attributes_Location struct {
...
type TestResultIncludedItemList_Data_Attributes_Result_Assertions struct {
	Actual any
	ErrorMessage any
	Expected any
	Operator any
...
type TestResultIncludedItemList_Data_Attributes_Result_BucketKeys struct {
...
type TestResultIncludedItemList_Data_Attributes_Result_Cert_Valid struct {
...
type TestResultIncludedItemList_Data_Attributes_Result_Cert struct {
...
type TestResultIncludedItemList_Data_Attributes_Result_DnsResolution struct {
...
type TestResultIncludedItemList_Data_Attributes_Result_Failure struct {
...
type TestResultIncludedItemList_Data_Attributes_Result_Handshake_Request_Files struct {
	BucketKey any
	Encoding any
	Name any
	Size any
...
type TestResultIncludedItemList_Data_Attributes_Result_Handshake_Request struct {
...
type TestResultIncludedItemList_Data_Attributes_Result_Handshake_Response_Cdn_Cache struct {
...
type TestResultIncludedItemList_Data_Attributes_Result_Handshake_Response_Cdn struct {
...
type TestResultIncludedItemList_Data_Attributes_Result_Handshake_Response_Close struct {
...
type TestResultIncludedItemList_Data_Attributes_Result_Handshake_Response_Healthcheck struct {
...
type TestResultIncludedItemList_Data_Attributes_Result_Handshake_Response_Records struct {
	Type any
	Values any
}

type TestResultIncludedItemList_Data_Attributes_Result_Handshake_Response_Redirects struct {
	Location any
	StatusCode any
}

type TestResultIncludedItemList_Data_Attributes_Result_Handshake_Response struct {
...
type TestResultIncludedItemList_Data_Attributes_Result_Handshake struct {
...
type TestResultIncludedItemList_Data_Attributes_Result_Netpath_Destination struct {
...
type TestResultIncludedItemList_Data_Attributes_Result_Netpath_Hops struct {
	Hostname any
	IpAddress any
	Reachable any
	Rtt any
...
type TestResultIncludedItemList_Data_Attributes_Result_Netpath_Source struct {
	// Hostname of the endpoint.
	Hostname any
}

type TestResultIncludedItemList_Data_Attributes_Result_Netpath struct {
...
type TestResultIncludedItemList_Data_Attributes_Result_Netstats_Hops struct {
...
type TestResultIncludedItemList_Data_Attributes_Result_Netstats struct {
...
type TestResultIncludedItemList_Data_Attributes_Result_Ocsp_Certificate struct {
...
type TestResultIncludedItemList_Data_Attributes_Result_Ocsp_Updates struct {
...
type TestResultIncludedItemList_Data_Attributes_Result_Ocsp struct {
...
type TestResultIncludedItemList_Data_Attributes_Result_Ping_Routers struct {
	Ip any
	ResolvedHost any
}

type TestResultIncludedItemList_Data_Attributes_Result_Ping struct {
	// Target hostname.
	Host any
	// Latency statistics for a network probe.
	Latency any
...
type TestResultIncludedItemList_Data_Attributes_Result_Steps_AssertionResult struct {
	Actual any
	CheckType any
	Expected any
...
type TestResultIncludedItemList_Data_Attributes_Result_Steps_Bounds struct {
	Height any
	Width any
	X any
	Y any
...
type TestResultIncludedItemList_Data_Attributes_Result_Steps_BrowserErrors struct {
	Description any
	Method any
	Name any
	Status any
...
type TestResultIncludedItemList_Data_Attributes_Result_Steps_CdnResources struct {
	Cdn any
	ResolvedIp any
	Timestamp any
	Timings any
...
type TestResultIncludedItemList_Data_Attributes_Result_Steps_ElementUpdates struct {
	MultiLocator any
	TargetOuterHtml any
	Version any
}

type TestResultIncludedItemList_Data_Attributes_Result_Steps_ExtractedValue struct {
	Err any
	ErrorMessage any
	Example any
	Id any
...
type TestResultIncludedItemList_Data_Attributes_Result_Steps_Retries struct {
}

type TestResultIncludedItemList_Data_Attributes_Result_Steps_RumContext struct {
	ApplicationId any
	SessionId any
	ViewId any
}

type TestResultIncludedItemList_Data_Attributes_Result_Steps_SubStep struct {
	Level any
	ParentStep any
	ParentTest any
}

type TestResultIncludedItemList_Data_Attributes_Result_Steps_SubTest struct {
	Id any
	PlayingTab any
	RumContext any
}

type TestResultIncludedItemList_Data_Attributes_Result_Steps_Tabs struct {
	Focused any
	Title any
	Url any
}

type TestResultIncludedItemList_Data_Attributes_Result_Steps_Variables struct {
	Config any
	Extracted any
}

type TestResultIncludedItemList_Data_Attributes_Result_Steps_VitalsMetrics struct {
	Cls any
	Fcp any
	Inp any
	Lcp any
...
type TestResultIncludedItemList_Data_Attributes_Result_Steps_Warnings struct {
	ElementBounds any
	Message any
	Type any
}

type TestResultIncludedItemList_Data_Attributes_Result_Steps struct {
	AllowFailure any
	ApiTest any
	AssertionResult any
	Assertions any
...
type TestResultIncludedItemList_Data_Attributes_Result_Trace struct {
...
type TestResultIncludedItemList_Data_Attributes_Result_Turns_Steps struct {
	BucketKeys any
	Config any
}

type TestResultIncludedItemList_Data_Attributes_Result_Turns struct {
	BucketKeys any
	Name any
	Reasoning any
	Status any
...
type TestResultIncludedItemList_Data_Attributes_Result struct {
...
type TestResultIncludedItemList_Data_Attributes struct {
...
type TestResultIncludedItemList_Data_Relationships_Test_Data struct {
...
type TestResultIncludedItemList_Data_Relationships_Test struct {
	// Data for the test relationship.
	Data any
}

type TestResultIncludedItemList_Data_Relationships struct {
	// Relationship to the Synthetic test.
	Test any
}

type TestResultIncludedItemList_Data struct {
...
type TestResultIncludedItemList_Included struct {
	Attributes any
	Id any
	Type any
}

type TestResultIncludedItemListConfig struct {
	EventId any
	PublicId any
	ResultId any
	Timestamp any
...
type TestResultIncludedItemListAttrs struct {
...
var TestResultIncludedItemList = ubx.DataSourceBinding{

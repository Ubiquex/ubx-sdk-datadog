...
type ApiPayloadDataList_Data_Attributes struct {
	CreatedAt         any
	ModifiedAt        any
	OrgId             any
...
type ApiPayloadDataList_Data struct {
	Attributes any
	Id         any
	Type       any
}

type ApiPayloadDataList_Meta_Page struct {
...
type ApiPayloadDataList_Meta_Schema_Fields struct {
	Name any
	Type any
}

type ApiPayloadDataList_Meta_Schema struct {
...
type ApiPayloadDataList_Meta struct {
...
type ApiPayloadDataListConfig struct {
	DatastoreId any
	Filter      any
	ItemKey     any
	Sort        any
...
type ApiPayloadDataListAttrs struct {
...
var ApiPayloadDataList = ubx.DataSourceBinding{

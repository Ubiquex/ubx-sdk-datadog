...
type AgentV2List_Data_Attributes_Tags struct {
	Key any
	Value any
}

type AgentV2List_Data_Attributes struct {
	AgentVersion any
	ApiKeyName any
	ApiKeyUuid any
	CloudProvider any
...
type AgentV2List_Data struct {
	Attributes any
	Id any
	Type any
}

type AgentV2List_Meta_Page struct {
...
type AgentV2List_Meta struct {
	// Pagination details for the v2 list of agents.
	Page any
}

type AgentV2ListConfig struct {
	Filter any
	PageNumber any
	PageSize any
	SortAttribute any
...
var AgentV2List = ubx.DataSourceBinding{

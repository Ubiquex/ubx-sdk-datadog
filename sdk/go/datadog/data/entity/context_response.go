...
type ContextResponse_Data_Attributes_Revisions struct {
	Attributes any
	FirstSeenAt any
	LastSeenAt any
}

type ContextResponse_Data_Attributes struct {
	Revisions any
}

type ContextResponse_Data struct {
	Attributes any
	Id any
	Type any
}

type ContextResponse_Meta_Page struct {
...
type ContextResponse_Meta struct {
...
type ContextResponseConfig struct {
	AsOf any
	From any
	Limit any
	PageToken any
...
type ContextResponseAttrs struct {
	AsOf any
...
var ContextResponse = ubx.DataSourceBinding{

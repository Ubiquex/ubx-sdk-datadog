...
type ResponseData_Data_Attributes_Cells_Attributes_SplitBy struct {
	Keys any
	Tags any
}
...
type ResponseData_Data_Attributes_TemplateVariables_AvailableValuesQuery_Search struct {
	Query any
}

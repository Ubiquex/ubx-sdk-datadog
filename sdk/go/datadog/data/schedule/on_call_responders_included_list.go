...
type OnCallRespondersIncludedList_Data_Attributes struct {
...
type OnCallRespondersIncludedList_Data_Relationships_Responders struct {
	// Array of references to the responder groups included in the response.
	Data any
}

type OnCallRespondersIncludedList_Data_Relationships_Schedule struct {

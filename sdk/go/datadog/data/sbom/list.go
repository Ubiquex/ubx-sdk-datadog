...
type List_Data_Attributes_Components_Licenses_License struct {
	Name any
}

type List_Data_Attributes_Components_Licenses struct {
	License any
}

type List_Data_Attributes_Components_Properties struct {
	Name any
	Value any
}

type List_Data_Attributes_Components struct {
	BomRef any
	Licenses any
	Name any
	Properties any
...
type List_Data_Attributes_Dependencies struct {
	DependsOn any
	Ref any
}

type List_Data_Attributes_Metadata_Component struct {
	Name any
	Type any
}
